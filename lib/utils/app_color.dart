...
class AppColor {
  static const Color colorPrimary = Color(0xFF020C16);
  static const Color colorSecondary = Color(0xFFFF6E32);
  static const Color colorFloating = Color(0xFF172434);
  static const Color colorNeutralStatus = Color(0xFF7ACEFA);
